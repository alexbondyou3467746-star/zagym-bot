...
# --- Заполнение базы данных расписанием (ОБНОВЛЕНО) ---
def populate_initial_data():
    ...
    schedule_data = [
        ...
        ('Пилатес', 'Четверг', '9:20-10:20', 'осанка и мягков укрепление'),
        ...
        # Суббота
        ('Здоровая спина', 'Суббота', '9:00-10:00', 'SPINEFITTER'),
    ...
    conn.commit()
    conn.close()
    logger.info("Расписание загружено (обновленная версия)")
...
# ОБНОВЛЕННОЕ СТАТИЧЕСКОЕ РАСПИСАНИЕ ДЛЯ КОМАНДЫ "Узнать расписание"
SCHEDULE_MESSAGE = """
